...
urlpatterns = [
    ...
    path("onepagecontextgenmetacogtask", views.onePageContextGenMetacogTask, name="onepagecontextgenmetacogtask"),
    path('onepagecontextgenmetacogupdate', views.onePageContextGenMetacogUpdate, name='onepagecontextgenmetacogupdate'),
    ...
    path("tutorialmetacog", views.tutorialmetacog, name="tutorialmetacog"),
